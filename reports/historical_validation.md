...
| scraper_observations | 63 |
| instruments | 103 |
| instruments_by_type | {'etf': 1, 'index': 9, 'ordinary': 80, 'preference': 2, 'reit': 1, 'rights': 10} |
| aliases | 7 |
| distinct_trade_dates | 4482 |
...
| ✅ | negative changes preserved (sign bug not reproduced) | 91293 negative, 87817 positive change_abs |
...
| ℹ️ | quality flags | {"date_repaired": 228, "scrape_date_is_observation_date": 63} |
| ✅ | every instrument trading in 2024 has a sector | unclassified-but-active: none |
| ℹ️ | unclassified instruments (delisted pre-2013, never guessed) | 18: ['ACCS', 'ALP', 'AMAC', 'BAUM', 'BERG', 'CITY', 'CMC', 'FMLY', 'HFCB', 'ICDC', 'KPC', 'MASH', 'PAFR', 'REA', 'SKL', 'TRFC', 'UTK', '^NBDI'] |
| ℹ️ | ordinary shares by sector | NULL=17; Commercial and Services=13; Banking=12; Manufacturing and Allied=8; Insurance=6; Agricultural=6; Investment=5; Energy and Petroleum=5; Construction and Allied=5; Telecommunication=1; Investment Services=1; Automobiles and Accessories=1 |
| ✅ | KCB has an unbroken 2007 -> latest series | 4482 rows, 2007-01-02..2026-09-12, 19 distinct years |
| ℹ️ | instruments by first-listing year | None:7, 2007:55, 2008:5, 2009:4, 2010:3, 2011:2, 2012:5, 2013:8, 2014:3, 2015:2, 2016:2, 2017:1, 2018:3, 2022:1, 2023:1, 2024:1 |
| ℹ️ | ordinary shares no longer present in 2024 (delisted) | 11: ['ACCS', 'BAUM', 'BERG', 'CITY', 'CMC', 'ICDC', 'MASH', 'PAFR', 'REA', 'UTK', 'KENO'] |
| ℹ️ | longest histories | EVRD 4482 rows 2007-01-02..2026-09-12; KCB 4482 rows 2007-01-02..2026-09-12; KEGN 4482 rows 2007-01-02..2026-09-12; ABSA 4481 rows 2007-01-02..2026-09-12; CABL 4481 rows 2007-01-02..2026-09-12 |
...
| ℹ️ | scraper tickers found in the archive | 57 of 64 scraped tickers have archive history; scraper-only (new listings or scraper-side codes): ['KPC', 'FMLY', 'AMAC', 'SKL', 'TRFC', 'ALP', 'HFCB'] |
| ℹ️ | company-name drift between sources for the same ticker (eyeball; ticker is the identity) | IMH: scraper 'I&M Group PLC' vs archive 'I & M Holdings Plc'; HFCK: scraper 'HFCB Group Plc' vs archive 'HF Group Ltd'; FTGH: scraper 'FTG Holdings Ltd' vs archive 'Flame Tree Group Holdings Ltd' |
...
| ℹ️ | scraper observations coexist in the same table | 63 rows with data_source = nse_scraper |
